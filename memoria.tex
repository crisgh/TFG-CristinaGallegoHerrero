...
Este Trabajo de Fin de Grado consiste en la recopilación, comparación y análisis de \textcolor{red}{varias} tecnologías de exploración y administración de \textcolor{red}{log y datos}. En este proyecto, se ha trabajado con Stack Exchange, que se trata de un conjunto de datos ya extraídos que contienen la información de Stack Overflow y otras comunidades similares. Estos datos se almacenan en una base de datos para, posteriormente, visualizarlos en las herramientas gráficas que vamos a comparar durante el proyecto y sacar conclusiones dependiendo de los diferentes criterios de comparación.\newline

Hemos decidido centrarnos en dos herramientas principales: Grafana y Graphite para análisis y visualización de los datos y Tableau, que realiza tanto la visualización como su análisis de manera directa.\newline

El objetivo principal es tener una comparativa de los diferentes sistemas de monitorización y análisis aplicando diferentes criterios de comparación.\newline

\textcolor{red}{FALTA INFORMACIÓN}
Este trabajo tiene como objetivo la recopilación de datos y el análisis de estos en diferentes herramientas de visualización de datos. 
...
El proceso de de análisis presenta una etapa previa que consiste en identificar y clasificar los datos antes de comenzar a analizarlos. Este proceso consiste en definir el alcance para tomar las especificaciones de los requisitos de los datos, su recolección  y procesamiento. 

En cualquier ámbito la visualización de la información tiene un valor muy importante, ya que es una manera sencilla de llegar a todos los públicos. Actualmente, todas las empresas de cualquier ámbito utilizan alguna herramienta de análisis que les permita visualizar los datos de manera centralizada y poder tomar decisiones. 
...
Durante este periodo se ha trabajado de manera diaria pero, sobre todo, durante los fines de semana que el nivel de esfuerzo ha sido mayor. 
    \begin{figure}
        \centering
...
Para el desarrollo de este Trabajo Fin de Grado se han utilizado diferentes tecnologías, las cuales se explican a continuación.
